...
describe('# Notification Component', () => {
  ...
  describe('## With $compile', () => {
    ...
    beforeEach($inject(($log, $compile, $rootScope) => {
      log = $log;
      scope = $rootScope.$new();
      element = angular.element('<tsfn-notification my-attribute="{{attr}}" my-one-way-binding="outside"></tsfn-notification>');
    ...
    it('should log registration', () => {
      let loaded = ['ngComponent', 'tsfnNotification', 'loaded'].join(' ');
    ...
    describe('### Controller', () => {
      ...
      beforeEach(() => {
        controller = element.controller('tsfnNotification');
      });
