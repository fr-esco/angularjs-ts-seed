...
describe('# Uacexample Component', () => {
  ...
  describe('## With $compile', () => {
    ...
    it('should log registration', () => {
      let loaded = ['ngComponent', 'tsfnUacexample', 'loaded'].join(' ');
    ...
    describe('### Controller', () => {
      ...
      beforeEach(() => {
        controller = element.controller('tsfnUacexample');
      });
  ...
  describe('## With $componentController', () => {
    ...
    beforeEach($inject(($rootScope, $componentController) => {
      scope = $rootScope.$new();
      controller = $componentController('tsfnUacexample', { $scope: scope }, {
        myAttribute: 'example',
        myOneWayBinding: '1.5'
      });
    }));
