...
import Uacexample from './uacexample';
...
describe('# Uacexample Module', () => {
  beforeEach($module(Uacexample));

  describe('## Existence', () => {
    let mod;

    beforeEach(() => mod = angular.module(Uacexample));
  ...
  describe('## Log enabled', () => {
    ...
    it('should log registration', () => {
      let loaded = ['ngModule', Uacexample, 'loaded'].join(' ');
